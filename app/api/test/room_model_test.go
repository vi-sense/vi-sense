...
func TestQueryRoomModel(t *testing.T) {
	...
	expected := "{\"id\":1,\"sensors\":[{\"id\":1,\"room_model_id\":1,\"latest_value\":0,\"mesh_id\":\"node358\"," +
		"\"name\":\"Flow Sensor\",\"description\":\"A basic flow sensor.\",\"measurement_unit\":\"°C\"," +
		"\"upper_bound\":null,\"lower_bound\":null,\"gradient_bound\":null}," +

		"{\"id\":2,\"room_model_id\":1,\"latest_value\":0,\"mesh_id\":\"node422\",\"name\":\"Return Flow Sensor\"," +
		"\"description\":\"A basic return flow sensor with a longer description. Lorem ipsum dolor sit amet, " +
		"consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam " +
		"erat, sed diam voluptua.\",\"measurement_unit\":\"°C\",\"upper_bound\":null,\"lower_bound\":null," +
		"\"gradient_bound\":null}," +

		"{\"id\":3,\"room_model_id\":1,\"latest_value\":0,\"mesh_id\":\"node441\",\"name\":\"Fuel Sensor\"," +
		"\"description\":\"A basic thermal sensor\",\"measurement_unit\":\"l\",\"upper_bound\":null," +
		"\"lower_bound\":null,\"gradient_bound\":null},{\"id\":4,\"room_model_id\":1,\"latest_value\":0," +
		"\"mesh_id\":\"node505\",\"name\":\"Pressure Sensor\",\"description\":\"A basic thermal sensor\"," +
		"\"measurement_unit\":\"bar\",\"upper_bound\":null,\"lower_bound\":null,\"gradient_bound\":null}]," +
		"\"name\":\"Facility Mechanical Room\",\"description\":\"This model shows a facility mechanical room " +
		"with lots of pipes and stuff.\",\"url\":\"files/facility-mechanical-room/model.zip\"," +
